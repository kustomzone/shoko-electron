            ...
            <ul className="nav navbar-toolbar navbar-right navbar-toolbar-right">
              <li className="nav-item dropdown">
                ...
                <div className="dropdown-menu" role="menu">
                  ...
                  <a className="dropdown-item" href="" role="menuitem">
                    <span className="flag-icon flag-icon-fr" /> French</a>
                  <a className="dropdown-item" href="" role="menuitem">
                    <span className="flag-icon flag-icon-cn" /> Chinese</a>
                  <a className="dropdown-item" href="" role="menuitem">
                    <span className="flag-icon flag-icon-de" /> German</a>
                  <a className="dropdown-item" href="" role="menuitem">
                    <span className="flag-icon flag-icon-nl" /> Dutch</a>
                </div>
              </li>
              <li className="nav-item dropdown">
                ...
                <div className="dropdown-menu" role="menu">
                  <a className="dropdown-item" href="" role="menuitem"><i className="icon wb-user" aria-hidden="true" /> Profile</a>
                  <a className="dropdown-item" href="" role="menuitem"><i className="icon wb-payment" aria-hidden="true" /> Billing</a>
                  <a className="dropdown-item" href="" role="menuitem"><i className="icon wb-settings" aria-hidden="true" /> Settings</a>
                  <div className="dropdown-divider" role="presentation" />
                  <a className="dropdown-item" href="" role="menuitem"><i className="icon wb-power" aria-hidden="true" /> Logout</a>
                </div>
              </li>
              <li className="nav-item dropdown">
